...
const RecentlyViewedSlide = () => {
    ...
    return (
        <div className="hidden lg:flex flex-col fixed top-40 left-4 w-40 max-h-[80vh] overflow-y-auto bg-white border border-yellow-300 shadow-lg rounded-xl p-3 z-10">
